                                    ...
                                    <div class="card-header border-0">
                                        <div class="row g-4">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a href="{{ route('dashboard-apps-ecommerce-add-product') }}" class="btn btn-success" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i> Add Product</a>
                                                </div>
                                            </div>
                                            <div class="col-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($product->gallery_image)
                                                            @php
                                                                $galleryImages =
                                                                    json_decode($product->gallery_image, true) ?: [];
                                                            @endphp
                                                            @foreach ($galleryImages as $gallery)
                                                                <img src="{{ asset('uploads/products/gallery/' . $gallery) }}"
                                                                    width="50" class="img-thumbnail me-1">
                                                            @endforeach
                                                        @endif
                                                    </td>
