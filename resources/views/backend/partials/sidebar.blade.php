                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarEcommerce">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{{ route('dashboard-apps-ecommerce-products') }}"
                                                        class="nav-link" data-key="t-products"> Products </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{{ route('dashboard-apps-ecommerce-add-product') }}"
                                                        class="nav-link" data-key="t-create-product"> Create Product
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                   ...
                                   @hasanyrole('super-admin|admin')
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarSuccessMsg">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{{ route('success.message') }}" class="nav-link"
                                                        data-key="t-basic">
                                                        Basic </a>
                                                </li>
                                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarTwoStep">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{{ route('two.step') }}" class="nav-link"
                                                        data-key="t-basic"> Basic
                                                    </a>
                                                </li>
                                                <li class="nav-item">
